...
dGeomTriMeshSetCallback = loadOde('dGeomTriMeshSetCallback', None, dGeomID, POINTER(dTriCallback))
dGeomTriMeshGetCallback = loadOde('dGeomTriMeshGetCallback', POINTER(dTriCallback), dGeomID)
dTriArrayCallback = CFUNCTYPE(None, dGeomID, dGeomID, POINTER(c_int32), c_int32)
dGeomTriMeshSetArrayCallback = loadOde('dGeomTriMeshSetArrayCallback', None, dGeomID, POINTER(dTriArrayCallback))
dGeomTriMeshGetArrayCallback = loadOde('dGeomTriMeshGetArrayCallback', POINTER(dTriArrayCallback), dGeomID)
dTriRayCallback = CFUNCTYPE(c_int32, dGeomID, dGeomID, c_int32, dReal, dReal)
dGeomTriMeshSetRayCallback = loadOde('dGeomTriMeshSetRayCallback', None, dGeomID, POINTER(dTriRayCallback))
dGeomTriMeshGetRayCallback = loadOde('dGeomTriMeshGetRayCallback', POINTER(dTriRayCallback), dGeomID)
dTriTriMergeCallback = CFUNCTYPE(c_int32, dGeomID, c_int32, c_int32)
dGeomTriMeshSetTriMergeCallback = loadOde('dGeomTriMeshSetTriMergeCallback', None, dGeomID, POINTER(dTriTriMergeCallback))
dGeomTriMeshGetTriMergeCallback = loadOde('dGeomTriMeshGetTriMergeCallback', POINTER(dTriTriMergeCallback), dGeomID)
dCreateTriMesh = loadOde('dCreateTriMesh', dGeomID, dSpaceID, dTriMeshDataID, POINTER(dTriCallback), POINTER(dTriArrayCallback), POINTER(dTriRayCallback))
